...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	private void setAddActionsStyle() {
		...
		builder.addJPushAction(R.mipmap.jpush_ic_richpush_actionbar_back, "second", "my_extra2");
		builder.addJPushAction(R.mipmap.jpush_ic_richpush_actionbar_back, "third", "my_extra3");
